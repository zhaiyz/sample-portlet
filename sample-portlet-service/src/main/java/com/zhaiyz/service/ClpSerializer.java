...
import com.zhaiyz.model.BookClp;
...
public class ClpSerializer {
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals("com.zhaiyz.model.impl.BookImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.zhaiyz.NoSuchBookException")) {
            return new com.zhaiyz.NoSuchBookException();
        }
